	...
	const slides = [
		{
			...
			text: 'Агентство представляем интересы клиентов в сфере продажи и приобретения жилья на рынках Подмосковья уже более 10 лет.',
		},
		{
					...
					<div className={styles.content}>
						...
						<div ref={textGroupRef} className={styles.textGroup}>
							<p className={styles.text}>
								...
								продажи и приобретения жилья на рынках Подмосковья уже
