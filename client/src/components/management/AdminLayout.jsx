...
import { FiHome, FiList, FiGrid, FiMessageSquare, FiMail, FiCheckSquare } from 'react-icons/fi';
...
export const AdminLayout = () => {
  ...
  const navItems = [
    ...
    { path: '/management/features', icon: <FiCheckSquare />, label: 'Особенности' },
    { path: '/management/requests', icon: <FiMessageSquare />, label: 'Заявки' },
    { path: '/management/feedback', icon: <FiMail />, label: 'Обратная связь' },
  ];
